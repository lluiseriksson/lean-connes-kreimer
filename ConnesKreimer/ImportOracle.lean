...
example (S : Type v) [CommRing S] (P : GraftingProvider.{u})
    ...
    D.graftOperator (a • forestMonomial S f) = a • P.graftGenerator S f :=
  D.graftOperator_smul_forestMonomial a f

example (S : Type v) [CommRing S] (P : GraftingProvider.{u})
    (D : AdmissibleCutData P S) (f g : Forest P.Tree) :
    D.graftOperator (forestMonomial S f + forestMonomial S g)
      = P.graftGenerator S f + P.graftGenerator S g :=
  D.graftOperator_add_forestMonomial f g

example (S : Type v) [CommRing S] (P : GraftingProvider.{u})
    (D : AdmissibleCutData P S) (n : Nat) (f : Forest P.Tree) :
    D.graftOperator (n • forestMonomial S f) = n • P.graftGenerator S f :=
  D.graftOperator_nsmul_forestMonomial n f

example (S : Type v) [CommRing S] (P : GraftingProvider.{u})
    (D : AdmissibleCutData P S) :
    D.graftOperator (0 : CKAlgebra S P.Tree) = 0 :=
  D.graftOperator_zero

example (S : Type v) [CommRing S] (P : GraftingProvider.{u})
    (D : AdmissibleCutData P S) (t : P.Tree) :
    D.graftOperator (treeGenerator S t)
      = P.graftGenerator S (Finsupp.single t 1 : Forest P.Tree) :=
  D.graftOperator_treeGenerator t

example (S : Type v) [CommRing S] (P : GraftingProvider.{u})
    (D : AdmissibleCutData P S) :
    D.graftOperator (1 : CKAlgebra S P.Tree)
      = P.graftGenerator S (0 : Forest P.Tree) :=
  D.graftOperator_one

example (S : Type v) [CommRing S] (P : GraftingProvider.{u})
    (D : AdmissibleCutData P S) (f : Forest P.Tree) :
    D.counit (D.graftOperator (forestMonomial S f)) = 0 :=
...
example (S : Type v) [CommRing S] (P : GraftingProvider.{u})
    (D : AdmissibleCutData P S) :
    D.counit (D.graftOperator (1 : CKAlgebra S P.Tree)) = 0 :=
...
example (S : Type v) [CommRing S] (P : GraftingProvider.{u})
    (D : AdmissibleCutData P S) :
    D.coproduct (D.graftOperator (1 : CKAlgebra S P.Tree))
      = (D.graftOperator (1 : CKAlgebra S P.Tree)) ⊗ₜ[S] 1
        + (TensorProduct.map LinearMap.id D.graftOperator)
